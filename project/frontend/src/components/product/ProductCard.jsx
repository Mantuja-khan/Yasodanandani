      ...
      <Link to={`/products/${product._id}`} className="card p-2 md:p-6 hover:shadow-lg transition-shadow block">
        <div className="flex space-x-2 md:space-x-6">
          ...
          <div className="flex-1">
            <h3 className="text-sm md:text-xl font-semibold text-gray-900 mb-1 md:mb-2">{product.name}</h3>
            <p className="text-gray-600 mb-1 md:mb-4 line-clamp-2 text-xs md:text-base">{product.description}</p>
